...
## Overview
The era when the Silver Kingdoms existed is called the **Silver Kingdoms Epoch** or the **Heraldic Epochs**. There were ten kingdoms, each of which had a perfectly palindromic name - a reflection of the holiness of symmetry that can be found in . However, it's more than likely that those names predate the rise of Vorin religion.
...
https://es.coppermind.net/wiki/Reinos_de_%C3%89poca