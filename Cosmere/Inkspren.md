...
When Enlightened by Sja-anat, they take on a different form -- they appear similar to a non-Enlightened inkspren, but appear radiant with colors.
...
In a bond altered by [[Sja-anat\|Sja-anat]], the Transportation surge is retained, but it is unknown how their surge of Transformation is affected. Enlightened inkspren are able to hide inside of their Radiant's bodies.
...
Inkspren have a particular way of speaking, using "be" instead of phrases like "be here" or "exist" -- for example, "a spren is" rather than "there's a spren here", or "a traitor is" instead of "a traitor exists". They prefer simple, limited body language. Many of their names evoke colors or liquids.
