...
**Dawnshard**: At least one [[Dawnshard\|Dawnshard]] can Connect a user to their current location, allowing them to speak and read the local language. This requires at least two-thousand [[Breath Equivalent Unit\|BEUs]].
...
** Tracking**: Certain entities are able to follow Connection in order to find people, such as the [[Messengers\|Messengers]] in the [[Cognitive Realm\|Cognitive Realm]].
** Body Swap**: Manipulation Connection in certain ways can allow one to swap souls between bodies. How this would be done intentionally is unknown, but it can be done on accident when creating a Connection between two people.
## Bonds
